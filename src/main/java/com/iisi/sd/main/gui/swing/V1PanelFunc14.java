...
public class V1PanelFunc14 extends JPanel {
    protected static Logger log = LoggerFactory.getLogger(V1PanelFunc14.class);
    private static final long serialVersionUID = -1852906988920722628L;
    private Pattern rldfPattern = Pattern.compile("6-4-.*.doc");

    public V1PanelFunc14() {
    ...
    private void handleExceptionErrors(Exception e1) {
        ...
        JOptionPane.showMessageDialog(V1PanelFunc14.this, sbf.toString(), "操作錯誤", JOptionPane.ERROR_MESSAGE);
    }
    ...
    private class ExecActionListener implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            if (srcDir.getFile() != null && destiDir.getFile() != null) {
                ...
                Map<String, String> scriptFinalDataMap = service2.generateFinalChineseColumn(srcList);
                try {
                ...
                JOptionPane.showMessageDialog(V1PanelFunc14.this, message, "匯出結果", JOptionPane.INFORMATION_MESSAGE);
            } else {
                JOptionPane
                        .showMessageDialog(V1PanelFunc14.this, "請必須指定目錄.........", "操作錯誤", JOptionPane.ERROR_MESSAGE);
            }
