...
public class V1PanelFunc15 extends JPanel {
	protected static Logger log = LoggerFactory.getLogger(V1PanelFunc15.class);
	...
	private class ExecActionListener implements ActionListener{		
		...
		public void actionPerformed(ActionEvent e) {
			if(srcDir.getFile()!=null && destiDir.getFile()!=null){
				...
				final RRRCTableServiceImpl service =new RRRCTableServiceImpl();
				...
				List<DataTable>  dableList = service.covertToRCDFRRDFFormRldfByCommonmethodX6000(srcList);				
				Map<String, String> scriptFinalDataMap = service2.generateFinalScript(dableList);
				 try {
	                ...
	                JOptionPane.showMessageDialog(V1PanelFunc15.this, message, "匯出結果", JOptionPane.INFORMATION_MESSAGE);
			}else{
				JOptionPane.showMessageDialog(V1PanelFunc15.this, "請必須指定目錄.........", "操作錯誤", JOptionPane.ERROR_MESSAGE);
			}
	...
	private void handleExceptionErrors(Exception e1) {
		...
		JOptionPane.showMessageDialog(V1PanelFunc15.this, sbf.toString(), "操作錯誤", JOptionPane.ERROR_MESSAGE);
	}
