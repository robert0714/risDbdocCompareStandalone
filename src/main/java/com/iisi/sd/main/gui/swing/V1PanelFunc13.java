...
import com.iisigroup.toolkits.service.X601TableServiceImpl;
import com.jgoodies.forms.factories.FormFactory;
import com.jgoodies.forms.layout.ColumnSpec;
import com.jgoodies.forms.layout.FormLayout;
import com.jgoodies.forms.layout.RowSpec;

public class V1PanelFunc13 extends JPanel {
    protected static Logger log = LoggerFactory.getLogger(V1PanelFunc13.class);
    private static final long serialVersionUID = -1852906988920722628L;
    private Pattern rldfPattern = Pattern.compile("6-4-RLDF.*.doc");

    public V1PanelFunc13() {
    ...
    private void handleExceptionErrors(Exception e1) {
        ...
        JOptionPane.showMessageDialog(V1PanelFunc13.this, sbf.toString(), "操作錯誤", JOptionPane.ERROR_MESSAGE);
    }
    ...
    private class ExecActionListener implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            if (srcDir.getFile() != null && destiDir.getFile() != null) {
                ...
                final X601TableServiceImpl service = new X601TableServiceImpl();
                ...
                JOptionPane.showMessageDialog(V1PanelFunc13.this, message, "匯出結果", JOptionPane.INFORMATION_MESSAGE);
            } else {
                JOptionPane
                        .showMessageDialog(V1PanelFunc13.this, "請必須指定目錄.........", "操作錯誤", JOptionPane.ERROR_MESSAGE);
            }
