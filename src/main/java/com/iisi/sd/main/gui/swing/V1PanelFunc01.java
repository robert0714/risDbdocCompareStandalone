...
public class V1PanelFunc01 extends JPanel {
    ...
    public V1PanelFunc01() {
        ...
        JLabel directionLabel = new JLabel("1.6-4 Table(*.doc) 目錄位置");
        add(directionLabel, "4, 2, fill, default");

        JButton docDirectionButton = new JButton("open ");
        final DirectionChooserActionListener docListener = new DirectionChooserActionListener(V1PanelFunc01.this) {
            void implementedMethod(File direction) {
            }
        };
        docDirectionButton.addActionListener(docListener);

        add(docDirectionButton, "6, 2");

        final JLabel driectionShow = docListener.getLabel();
        ...
        JProgressBar docProgressBar = docListener.getProgressBar();
        ...
        final DirectionChooserActionListener scriptListener = new DirectionChooserActionListener(V1PanelFunc01.this) {
            void implementedMethod(File direction) {
            }
        };
        ;
        ...
        final DirectionChooserActionListener outputFileListener = new DirectionChooserActionListener(V1PanelFunc01.this) {
            void implementedMethod(File direction) {
            }
        };
        ...
        GenerateDiscrepancyReportActionListener<DataTable, ScriptTableInfo> generateDiscrepancyReportActionListener = new GenerateDiscrepancyReportActionListener<DataTable, ScriptTableInfo>();
        generateDiscrepancyReportActionListener.setDocDataSource(docImportActionListener);
        ...
        clearImportDataButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                docImportActionListener.getDataList().clear();
                outputFileListener.clear();
                scriptListener.clear();
                docListener.clear();
        ...
        docImportActionListener.getObserveredButtonList().add(docDirectionButton);
        docImportActionListener.getObserveredButtonList().add(outPutFileButton);
    ...
    class DocImportActionListener implements ActionListener, DataSourceInterface<DataTable>, PropertyChangeListener {
        ...
        // public void setObserveredButton(JButton button) {
        // this.observeredButton = button;
        // }
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            if (directionChooserInterface.getFile() == null) {
                JOptionPane
                        .showMessageDialog(V1PanelFunc01.this, "請指定資料夾", "error operation", JOptionPane.ERROR_MESSAGE);
                        ...
                        public void implementsMethod() {
                            ...
                            if (dataList != null) {
                                ...
                                String message = "計有:  " + (dataList.size() - errors) + " 檔案，成功匯入比較格式。\n\r" + "\t "
                                        + errors + " 檔案，失敗匯入比較格式。\n\r";
                                JOptionPane.showMessageDialog(V1PanelFunc01.this, message, "統計結果",
                ...
                task = new Task() {
                    public void implementsMethod() {
                        ...
                        try {
                            ...
                            if (isException) {
                                JOptionPane.showMessageDialog(V1PanelFunc01.this, message + "失敗：  " + errorMessage,
                                        "error Exception", JOptionPane.ERROR_MESSAGE);
                            } else {
                                JOptionPane.showMessageDialog(V1PanelFunc01.this, message, "比對結果",
                                        JOptionPane.INFORMATION_MESSAGE);
                            }
