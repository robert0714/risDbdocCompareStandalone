...
public class V1PanelFunc03 extends JPanel {
    private static final long serialVersionUID = 5231234098124160155L;
    protected static Logger log = LoggerFactory.getLogger(V1PanelFunc03.class);
    ...
    private void handleExceptionErrors(Exception e1) {
        ...
        JOptionPane.showMessageDialog(V1PanelFunc03.this, sbf.toString(), "操作錯誤", JOptionPane.ERROR_MESSAGE);
    }
    ...
    class FileChooserActionListener implements ActionListener, DirectionChooserInterface {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            int returnVal = fc.showOpenDialog(V1PanelFunc03.this);
    ...
    class ExportImplementedFileActionListener extends DirectionChooserActionListener {
        ...
        void implementedMethod(File direction) {
            ...
            if (this.eachRegRLDFSFileChooserInterface == null
                    || this.eachRegRLDFSFileChooserInterface.getFile() == null) {
                String message = "各項登記申請書獨有欄位資料檔案必匯入..";
                JOptionPane.showMessageDialog(V1PanelFunc03.this, message, "操作錯誤", JOptionPane.ERROR_MESSAGE);
                return;
            }
            if (this.eachRegXLDFSFileChooserInterface == null
                    || this.eachRegXLDFSFileChooserInterface.getFile() == null) {
            ...
            if (StringUtils.isNotEmpty(symol)) {
                ...
                try {
                    ...
                    // 各項登記申請書獨有欄位
                    final DataTable eachRegRLDFSDataTable = service
                            .readTemplateDataTable(this.eachRegRLDFSFileChooserInterface.getFile());
                   

                    // 各項XLDFS系列獨有欄位
                    DataTable eachRegXLDFSDataTable = service
                            .readTemplateDataTable(this.eachRegXLDFSFileChooserInterface.getFile());
                   

                    // 申請書共通欄項
                    DataTable regCommonDataTable = service.readTemplateDataTable(this.regCommonFileChooserInterface
                            .getFile());
                    

                    // 外來申請書共通欄項
                    DataTable externalRegDataTable = service.readTemplateDataTable(this.externalRegFileChooserInterface
                            .getFile());
                   

                    // XLDF共通欄項
                    DataTable xldfsCommonDataTable = service.readTemplateDataTable(this.xldfsCommonFileChooserInterface
                            .getFile());
                    

                    // 產生6-4 table doc
                    String chtName = this.chtName.getText();
                    docList = service.generate64TableDocFromTemplate(symol, chtName, eachRegRLDFSDataTable,
                            eachRegXLDFSDataTable, regCommonDataTable, externalRegDataTable, xldfsCommonDataTable);
...
//                    }
                ...
                JOptionPane.showMessageDialog(V1PanelFunc03.this, message, "匯出結果", JOptionPane.INFORMATION_MESSAGE);
