...
public class V1PanelFunc11 extends JPanel {
	protected static Logger log = LoggerFactory.getLogger(V1PanelFunc11.class);
			...
			if(srcDir.getFile()!=null && destiDir.getFile()!=null){
				...
				Map<String, String> scriptFinalDataMap = service2.generateFinalScript(dableList);
				 try {
	                ...
	                JOptionPane.showMessageDialog(V1PanelFunc11.this, message, "匯出結果", JOptionPane.INFORMATION_MESSAGE);
			}else{
				JOptionPane.showMessageDialog(V1PanelFunc11.this, "請必須指定目錄.........", "操作錯誤", JOptionPane.ERROR_MESSAGE);
			}
	...
	private void handleExceptionErrors(Exception e1) {
		...
		JOptionPane.showMessageDialog(V1PanelFunc11.this, sbf.toString(), "操作錯誤", JOptionPane.ERROR_MESSAGE);
	}
