...
@XmlType(name = "rldf088thType", propOrder = {
    "applyTransactionId",
    "applySequenceId",
    "personId",
    "siteId",
    ...
    "mrgDevPlaceCode",
    "wwAreaCode"})
@XmlRootElement(name = "Rldf088thType", namespace = "http://tw.gov.moi/domain")
public class Rldf088thType implements java.io.Serializable { 
    ...
    public int hashCode(){
        ...
        result = prime * result + ((this.removeYyymmdd == null) ? 0 : this.removeYyymmdd.hashCode());
        result = prime * result + ((this.removeTime == null) ? 0 : this.removeTime.hashCode());
        return result;
    }
    ...
    public boolean equals(Object obj) {
        ...
        Rldf088thType other = (Rldf088thType) obj;
        ...
        if(this.removeYyymmdd == null){
            if (other.removeYyymmdd!=null){
                return false;
            }
        }else if(!this.removeYyymmdd.equals(other.removeYyymmdd)){
            return false;
        }
        if(this.removeTime == null){
            if (other.removeTime!=null){
                return false;
            }
        }else if(!this.removeTime.equals(other.removeTime)){
            return false;
        }
        return true;
    }
